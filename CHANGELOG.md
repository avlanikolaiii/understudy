...
- **Start skills from anywhere:** a shortcut per skill, a menu of skills when you click the notch at rest, `understudy://run?skill=<name>` links (with values as query items), and macOS notifications when a run ends or waits for your OK. Links and the notch menu count down first.
