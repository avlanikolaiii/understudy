...
| Area | State |
|---|---|
| Mac app | Main window, a live notch strip, accounts, and Sample mode. **Watch records for real** (screen video and actions, on the Mac), and **recorded skills run for real**, by hand or on a schedule or trigger. AI learning isn't built yet; the sample report's rehearsal is **simulated**. |
...
- [Mac app guide](docs/app/interface-prototype.md), [Watch](docs/app/watch.md), [running skills](docs/app/run.md), [keyboard shortcuts](docs/app/keyboard-shortcuts.md), [report engine](docs/app/report-engine.md)
