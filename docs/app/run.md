...
- **The notch menu:** click the notch while it's at rest and it opens into a menu of the skills with steps, as tiles, plus **Teach** and **Open Understudy** (see [interface-prototype.md](interface-prototype.md)). A skill chosen there counts down for 10 seconds first, so a stray click can be undone. Runs you start yourself (a tile, a link) don't wait for you to stop typing or clicking, as triggers do.
